/*==============================================================================
  ...
  Prev: slc_macros.h               vmsstat_t.
        camblkstruc.hm              (Optional) CAMPKGP_TDEF, campkgp_t.
...
==============================================================================*/
 ...
 /* 16 bits).  Stronger version provided by camblkstruc.hm if latter   */
...
#define CAMPKGP_TDEF
 ...
 vmsstat_t camgo_start_pscd(void *mbcd_siop, unsigned int prior, int wait);
